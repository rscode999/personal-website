                ...
                <Navbar/>
                    ...
                    <section id='cast' className='projects-section'>
                        ...
                        <p className="projects-desc">
                            The Compartmentalized Autograd System with Tensors (CAST) is the successor to the CNet neural network framework.
                    ...
                    <section id='embedded-final-proj' className='projects-section'>
                        ...
                        <p className="projects-desc">
                            ...
                            With the help of 2 others, I implemented this device for a class final project.
                        </p>
                        <p className="projects-desc">
                    ...
                    <section id='geodata-website' className='projects-section'>
                        ...
                        <p className="projects-desc">
                            As part of the GeoData project team, I improved the team's website.
                    ...
                    <section id='utilities' className='projects-section'>
                        ...
                        <p className="projects-desc">
                            Consists of a space-efficient resizeable 2d array, memory-saving integer class with arbitrarily many digits,
